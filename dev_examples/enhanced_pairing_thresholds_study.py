# enhanced_pairing_thresholds_study.py
"""
Enhanced Pairing Thresholds Study: Validation Pairs + Service Reliability Analysis

Research Question: How does pairing interact with supply-demand conditions across 
different absolute scales, affecting both mean performance and service reliability?

Enhanced Design:
- Load Ratios: [3.0, 5.0] with validation pairs
- Baseline: (1.0, LR) vs 2x Baseline: (2.0, 2×LR) 
- Pairing Thresholds: restaurants=4.0km, customers=3.0km
- Enhanced Metrics: Mean assignment time + Within-replication std (service reliability)

This reveals:
1. How absolute scale interacts with pairing effectiveness
2. Whether pairing affects service reliability (within-rep variability)
3. Robustness of pairing benefits across different operational intensities
"""
...
if table_data:
    ...
    print(f"2. Does pairing affect service reliability (within-rep std)?")
    print(f"3. Are pairing benefits robust across operational intensities?")
    ...
    print(f"• Does pairing improve or worsen service reliability (within-rep std)?")
    print(f"• Are there scale-dependent pairing benefits?")
    print(f"• Which combination shows most promising results?")
    
    print(f"\n✅ ENHANCED PAIRING ANALYSIS COMPLETE!")
    print(f"✓ Validation pairs tested across load ratios")
    print(f"✓ Service reliability (within-rep std) analyzed")
    print(f"✓ Complete interaction effects revealed")
    print(f"✓ Foundation for thesis-level pairing strategy insights")
...
print("✓ Method: Validation pairs + Service reliability analysis")
print("✓ Evidence: Pairing effectiveness + Mean performance + Service variability")
print("✓ Next: Threshold sensitivity analysis if patterns are promising")
# %%